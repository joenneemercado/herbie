...
export const findSegmentAudienceSchema = z.object({
  ...
  date_birth_end: z
    ...
    .nullish()
    .optional(),
  date_order_start: z.string().nullish().optional(),
  date_order_end: z.string().nullish().optional(),
  ticket_order_start: z.string().nullish().optional(),
  ticket_order_end: z.string().nullish().optional(),
  seller_preference_id: z
    .union([z.string(), z.array(z.string())])
    .optional()
    .transform((val) => {
      if (!val) return [];
